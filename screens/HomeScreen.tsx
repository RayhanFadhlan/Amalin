...
export default function HomeScreen({ navigation }) {
  ...
  const [doas, setDoas] = useState(mockDoas.slice(0, 3));
  const [articles, setArticles] = useState(mockArticles.slice(0, 3));
      ...
      <Card style={styles.doaCard}>
        ...
        <View style={styles.doaActions}>
          <TouchableOpacity style={styles.actionButton}>
            <FontAwesome5 name="hands-helping" size={16} color={Colors.light.subtext} />
      ...
      >
        ...
        <Card style={styles.quoteCard}>
          <View style={styles.quoteIconContainer}>
            <Ionicons name="quote" size={24} color="#fff" />
          </View>
        ...
        <View style={styles.menuContainer}>
          ...
          >
            <View style={[styles.menuIconContainer, { backgroundColor: '#1E88E5' }]}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#43A047' }]}>
          ...
          >
            <View style={[styles.menuIconContainer, { backgroundColor: '#7B1FA2' }]}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#FB8C00' }]}>
        ...
        <View style={styles.menuContainer}>
          <TouchableOpacity style={styles.menuItem}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#E53935' }]}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#039BE5' }]}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#00897B' }]}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#8E24AA' }]}>
